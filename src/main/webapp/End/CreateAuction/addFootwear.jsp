...
if (endDate.equals("")) {
	...
	if (manLoc.equals("") || brand.equals("") || color.equals("") || material.equals("") || endDate.equals("") || reservePrice.equals("")
		...
		out.println("One of your entry fields is empty, please try again. <div><a href='footwearListing.jsp'>Try again</a></div>");
	} else if (!properDate) {
		out.println("Auction end date is invalid, please try again. <div><a href='footwearListing.jsp'>Try again</a></div>");
	} else {
